...
//     // If there's a URL, try network image with errorBuilder; otherwise use asset or initials.
//     if (hasUrl) {
//       return ClipOval(
//         child: SizedBox(
//           width: radius * 2,
...
//     // No URL: show asset if available, otherwise initials
//     return ClipOval(
//       child: SizedBox(
//         width: radius * 2,
//         height: radius * 2,
...
//           fit: BoxFit.cover,
//           errorBuilder: (context, error, stackTrace) {
//             // If asset missing, show initials fallback
//             return Container(
//               color: Colors.white24,
//               child: Center(
//                 child: Text(
